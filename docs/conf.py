#
# jira_svc Python Client documentation build configuration file, created by
...
nitpick_ignore = [
    ("py:class", "jira_svc"),  # in jira_svc.resources we only import this class if type
    ("py:class", "jira_svc.resources.AnyLike"),  # Dummy subclass for type checking
...
htmlhelp_basename = "jira_svcpythondoc"
...
man_pages = [
    ("index", "jira_svcpython", "jira_svc-python Documentation", ["Atlassian Pty Ltd."], 1)
]
